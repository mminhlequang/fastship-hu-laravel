...
@section('main-content')
    <div class="box">
        <div class="content-header border-bottom pb-5">
            ...
            @can('DistrictController@store')
                <a href="{{ url('/admin/districts/create') }}" class="btn btn-default float-right"
        ...
        <div class="box-header">
            <div class="box-tools" style="display: flex;">
                ...
                {!! Form::open(['method' => 'GET', 'url' => '/admin/districts', 'class' => 'pull-left', 'role' => 'search'])  !!}
        ...
        <div class="box-body table-responsive no-padding">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th class="text-left"width="5%">{{ __('Tỉnh/Thành phố') }}</th>
                    ...
                    <tr>
                        ...
                        <td class="dropdown text-center">
                            ...
                            <div class="dropdown-menu p-0">
                                @can('DistrictController@show')
                                    <a href="{{ url('/admin/districts/' . $item->id) }}" title="{{ __('Xem') }}"><button class="btn btn-info dropdown-item"><i class="fas fa-eye"></i> {{ __('message.user.view_user') }}</button></a>
                                @endcan
                                @can('DistrictController@update')
                                    <a href="{{ url('/admin/districts/' . $item->id . '/edit') }}" title="{{ __('Sửa') }}"><button class="btn btn-primary dropdown-item"><i class="far fa-edit" aria-hidden="true"></i> {{ __('message.user.edit_user') }}</button></a>
                                @endcan
