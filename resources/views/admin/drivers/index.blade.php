    ...
    <div class="box">
        ...
        <div class="box-header">
            <div class="box-tools" style="display: flex;">
                ...
                {!! Form::open(['method' => 'GET', 'url' => '/admin/drivers', 'class' => 'pull-left', 'role' => 'search'])  !!}
        ...
        <div class="box-body no-padding table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th>@sortablelink('name', trans('drivers.name'))</th>
                    <th>@sortablelink('phone', trans('drivers.phone'))</th>
                    <th>@sortablelink('phone', trans('drivers.email'))</th>
