    ...
    <div class="flex flex-col gap-10">
        ...
        <div class="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
            ...
            >
                ...
                <img data-src="{{ url('assets/images/how_we_work_img_1.svg') }}" class="mx-auto w-[75%] lazyload"/>
            </div>
            <div
            ...
            >
                ...
                <img data-src="{{ url('assets/images/how_we_work_img_4.svg') }}" class="mx-auto w-[75%] lazyload"
                />
            </div>
        </div>
    </div>
