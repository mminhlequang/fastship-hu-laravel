...
class PartnerController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $customers = $customers->where('type', 3)->whereNull('deleted_at')->latest()->paginate($perPage);

        return view('admin.partners.index', compact('customers'));
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.partners.show', compact('customer'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.partners.edit', compact('customer', 'birthday'));
    }
