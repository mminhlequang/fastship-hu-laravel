    ...
    <section class="dialog-infomation p-6 bg-[#FFFFFF] rounded-[1.625rem] h-fit w-full max-w-[375px]">
        <div class="flex items-center pb-4 border-b border-[#F8F1F0]">
          ...
          <svg width="10" height="10" viewBox="0 0 10 10" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M8.53516 1.46484L1.46409 8.53591" stroke="#7A838C" stroke-width="1.5" stroke-linecap="round"></path>
            <path d="M1.46387 1.46484L8.53493 8.53591" stroke="#7A838C" stroke-width="1.5" stroke-linecap="round"></path>
          </svg>
        </span>
        </div>
