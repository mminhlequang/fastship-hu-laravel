    ...
    <div class="box">
        <div class="content-header border-bottom pb-5">
            ...
            @can('NewsController@store')
                <a href="{{ url('/admin/news/create') }}" class="btn btn-default float-right"
        ...
        <div class="box-body  no-padding">
            <table class="table table-bordered table-hover">
                ...
                <tr>
                    ...
                    <th class="text-left">{{ trans('theme::news.image') }}</th>
                    <th>@sortablelink('title',trans('theme::news.title'))</th>
                    <th class="text-left">{{ trans('theme::news.description') }}</th>
                    <th class="text-left" width="8%">{{ trans('theme::news.active') }}</th>
                ...
                @if($news->count() == 0)
                    <tr>
                        <td class="text-left" colspan="9">{{ trans('theme::bookings.no_item') }}</td>
                    </tr>
                @endif
            </table>
        </div>
