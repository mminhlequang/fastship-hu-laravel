<h6 class="text-[#363E57] mb-3 text-base lg:text-lg tracking-[1%] leading-[1.2]">
...
<div class="flex flex-col gap-2 py-4 border-b border-b-[#CEC6C5] border-t border-t-[#CEC6C5]">
    ...
    <div class="flex text-sm lg:text-base text-[#847D79] justify-between">
        <span>Discount</span>
        <span class="text-[#F17228] font-medium text-sm lg:text-base">-{{ isset($discount) ? number_format($discount, 0, '.', '') : 0.00 }} Ft</span>
    </div>
    <div class="flex text-sm lg:text-base text-[#847D79] justify-between">
        <span>Shipping Fee</span>
        <span class="text-[#091230] font-medium text-sm lg:text-base">{{ isset($shipFee) ? number_format($shipFee, 0, '.', '') : 0.00 }} Ft</span>
    </div>
</div>
<div
...
>
    <span>Total</span>
    <span>{{ isset($total) ? number_format($total, 0, '.', '') : 0.00 }} Ft</span>
</div>
