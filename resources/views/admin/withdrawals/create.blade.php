...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('admin/withdrawals') }}">{{ __('province.province-list') }}</a></li>
...
<div class="box">
    ...
    {!! Form::open(['url' => 'admin/withdrawals', 'class' => 'form-horizontal', 'files' => true]) !!}

    @include('admin.withdrawals.form')
