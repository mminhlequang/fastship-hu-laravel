...
<section id="top-rated" class="section-top-padding">
                    ...
                    <div class="flex flex-col gap-2 mt-5">
                        <div class="flex items-center gap-2">
                            <span class="flex items-center capitalize gap-1 text-muted">
                                ...
                                <span class="line-clamp-1">{{ optional($itemPT->store)->name }}</span>
                            </span>
                        ...
                        <div class="flex items-center gap-2">
                            <div class="flex-1 flex items-center gap-1 text-lg">
                                <span class="text-muted line-through">{{ number_format($itemPT->price + 5, 1, '.', '') }}&nbsp;Ft</span>
                                <span class="text-secondary font-medium">{{ number_format($itemPT->price, 1, '.', '') }}&nbsp;Ft</span>
                            </div>
