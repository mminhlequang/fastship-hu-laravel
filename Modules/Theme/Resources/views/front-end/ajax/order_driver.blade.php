...
<div class="driver-panel p-4" style="">
    ...
    <div class="flex items-center mt-2">
        <div class="w-12 h-12 rounded-full mr-3 overflow-hidden avatar-pulse">
            <img src="https://placehold.co/600x400" alt="Driver" class="w-full h-full object-cover">
        </div>
        <div>
            <div class="font-bold">Frances Serano</div>
            <div class="text-orange-500 text-sm">+1 999 555 1101</div>
