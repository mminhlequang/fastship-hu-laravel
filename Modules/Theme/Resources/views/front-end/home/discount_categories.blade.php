...
@endforeach
<a href="{{ url('stores') }}" class="capitalize flex items-center text-primary hover:opacity-70 text-sm md:text-base"> {{ __('theme::web.view_all_dish') }} <img data-src="{{ url('assets/icons/up_right_icon.svg') }}" class="w-5 h-5 lazyload" ></a>