<!-- OTP Modal -->
<div id="otpModal" class="bg-black bg-opacity-50 fixed inset-0 hidden flex justify-center items-center min-h-screen">
    <div class="bg-white rounded-xl shadow-xl w-full max-w-lg p-6 relative">
        <div class="flex items-center mb-2">
            <button id="closeModalBtn" class="text-gray-700 text-2xl mr-3 bg-transparent border-0 cursor-pointer">
                <img src="./assets/icons/icon_left.svg" alt="Close" />
            </button>
        ...
        <form id="registrationForm">
            ...
            <div class="flex justify-between">
                <button type="button" class="flex-1 py-3 rounded-full border border-gray-300 text-gray-700 bg-white text-base cursor-pointer text-center mr-2" id="cancelBtn">Cancel</button>
...
<script>
    ...
    verifyBtn.addEventListener('click', () => {
        ...
        alert('OTP verification successful: ' + otpValue);
        closeModal();
    });
