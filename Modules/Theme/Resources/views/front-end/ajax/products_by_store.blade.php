                ...
                <div class="flex flex-col my-2">
                    ...
                    <div class="flex items-center justify-between font-medium">
                        <div class="flex items-center gap-1 text-base md:text-lg">
                            <span class="text-price-gray text-xl line-through">{{ number_format($itemP->price ?? 0 + 5, 1) }}&nbsp;Ft</span>
                            <span class="text-xl text-secondary">{{ number_format($itemP->price ?? 0, 1) }}&nbsp;Ft</span>
                        </div>
