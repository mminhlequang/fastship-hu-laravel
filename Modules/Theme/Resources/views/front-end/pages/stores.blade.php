...
@section('title')
    <title>{{ __('Fast ship Hu Stores') }}</title>
    <meta name="description"
          content="{{ __('Fast ship Hu Stores') }}"/>
    <meta name="keywords" content="{{ __('Fast ship Hu Stores') }}"/>
@endsection
@section('content')
    <main>
                        ...
                        <div class="flex items-center gap-4">
                            <div class="custom-btn-prev-slide w-12 h-12 flex rounded-full border border-solid border-black/05 hover:bg-primary/10 transition-all hover:text-primary hover:border-primary/10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none"
                                    ...
                                    <path d="M14.5 17L9.5 12L14.5 7" stroke="currentColor" stroke-width="1.5"
                            ...
                            <div class="custom-btn-next-slide w-12 h-12 flex rounded-full border border-solid border-black/05 hover:bg-primary/10 transition-all hover:text-primary hover:border-primary/10">
                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" class="m-auto"
                        ...
                        @foreach ($popularCategories as $itemC)
                            <div class="swiper-slide rounded-2xl cursor-pointer">
                                <div data-id="{{ $itemC->id }}" class="selectCategory relative rounded-2xl bg-white p-4 mt-2 flex flex-col gap-8 transition-all hover:shadow-[0_2px_0_0_#75ca45,0_-2px_0_0_#75ca45,-2px_0_0_0_#75ca45,2px_0_0_0_#75ca45,0_5px_0_0_#75ca45]">
                                    ...
                                    <img data-src="{{ url($itemC->image) }}" width="120" height="96" class="lazyload" alt="Food Category" onerror="this.onerror=null; this.src='{{ url('images/no-image.png') }}'"/>
