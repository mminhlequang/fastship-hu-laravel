...
@section('main-content')
    <div class="box">
        <div class="box-header with-border">
            ...
            <div class="box-tools">
                <a href="{{ url('/admin/notifications') }}" class="btn btn-default"><i class="fa fa-arrow-left" aria-hidden="true"></i> <span class="hidden-xs">{{ __('message.lists') }}</span></a>
            </div>
        </div>

        {!! Form::model($data, [
            'method' => 'PATCH',
            'url' => ['/admin/notifications', $data->id],
