<div class="box-body">
    <table class="table-layout table table-striped table-bordered">
        ...
        <tr>
            ...
            <td>{{ __('message.user.password_new') }}</td>
            <td>
                <div class="{{ $errors->has('password') ? ' has-error' : ''}}">
                    {!! Form::password('password', ['class' => 'form-control input-sm', 'autofill' => 'false']) !!}
        ...
        <tr>
            ...
            <td>
                <div class="{{ $errors->has('profile.birthday') ? ' has-error' : ''}}">
                    {!! Form::text('profile[birthday]', null, ['class' => 'form-control input-sm datepicker', 'autocomplete' => 'off']) !!}
