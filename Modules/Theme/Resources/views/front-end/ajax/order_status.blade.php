@if(isset($order))
    <div class="grid grid-cols-2 lg:grid-cols-4 gap-y-2 lg:gap-y-0 items-center">
        <div class="flex items-center">
            <div class="flex w-full flex-col border {{ ($order->progress_status == 'pending') ? 'border-primary-700' : 'border-[#F1EFE9]' }} items-center gap-2 px-1 py-2 rounded-xl">
        ...
        <div class="flex items-center">
            <div class="flex w-full flex-col border {{ ($order->progress_status == 'driverArrivedStore') ? 'border-primary-700' : 'border-[#F1EFE9]' }} items-center gap-2 px-1 py-2 rounded-xl">
        ...
        <div class="flex items-center">
            <div class="flex w-full flex-col border {{ ($order->progress_status == 'driverPicked') ? 'border-primary-700' : 'border-[#F1EFE9]' }} items-center gap-2 px-1 py-2 rounded-xl">
        ...
        <div class="flex items-center">
            <div class="flex w-full flex-col border {{ ($order->progress_status == 'completed') ? 'border-primary-700' : 'border-[#F1EFE9]' }} items-center gap-2 px-1 py-2 rounded-xl">
