...
<ol class="breadcrumb">
    ...
    <li><a href="{{ url('admin/withdrawals') }}">    {{ __('province.province-list') }}
    </a></li>
...
<div class="box">
    ...
    {!! Form::model($data, [
    'method' => 'PATCH',
    'url' => ['admin/withdrawals', $data->id],
    'class' => 'form-horizontal',
    'files' => true
    ]) !!}
    @include ('admin.withdrawals.form', ['submitButtonText' => __('message.update')])
