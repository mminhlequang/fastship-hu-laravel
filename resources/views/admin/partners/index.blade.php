...
@section('main-content')
    <div class="box">
        <div class="content-header border-bottom pb-5">
            <h5 class="float-left">
                {{ trans('partners.title') }}
            </h5>
        </div>
        <div class="box-header">
            <div class="box-tools" style="display: flex;">

                {!! Form::open(['method' => 'GET', 'url' => '/admin/partners', 'class' => 'pull-left', 'role' => 'search'])  !!}
        ...
        <div class="box-body no-padding table-responsive">
            <table class="table table-hover">
                ...
                <tr>
                    ...
                    <th>@sortablelink('name', trans('partners.name'))</th>
                    <th>@sortablelink('phone', trans('partners.phone'))</th>
                    <th>@sortablelink('phone', trans('partners.email'))</th>
