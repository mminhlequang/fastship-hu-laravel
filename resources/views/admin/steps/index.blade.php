...
<div class="box">
    <div class="content-header border-bottom pb-5">
        ...
        @can('StepController@store')
            <div class="aa" style="float:right;">

                <a href="{{ url('/admin/steps/create') }}" class="btn btn-default float-right"
    ...
    <div class="box-header">
        <div class="box-tools">
            {!! Form::open(['method' => 'GET', 'url' => '/admin/steps', 'class' => 'pull-left', 'role' => 'search']) !!}
        ...
        <table class="table table-striped">
            <tbody>
                <tr>
                    ...
                    <th>@sortablelink('title',trans('steps.name'))</th>
                ...
                <tr>
                    ...
                    <td class="dropdown">
                        ...
                        <div class="dropdown-menu p-0">
                            @can('StepController@show')
                                <a href="{{ url('/admin/steps/' . $item->id) }}"
                            ...
                            @can('StepController@update')
                                <a href="{{ url('/admin/steps/' . $item->id . '/edit') }}"
